...
using Tyuiu.BolohovcevaSV.Sprint0.Task7.V0.Lib;

namespace Tyuiu.BolohovcevaSV.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнила: Болоховцева С. В. | СМАРТб-26-1";
            Console.WriteLine("***************************************************************************");
